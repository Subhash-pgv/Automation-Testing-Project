...
public class ExtentReportManager implements ITestListener {
    ...
    public void onStart(ITestContext context) {
        ...
        String reportPath = "C:/Users/svegi/eclipse-workspace/O2technologiesAutomation/ExtendReports/myreport_" + timestamp + ".html";
    ...
    public String captureScreenshot(String screenshotName) throws IOException {
        String timestamp = new SimpleDateFormat("yyyy_MM_dd_HH_mm_ss").format(new Date());
        String filePath = "C:/Users/svegi/eclipse-workspace/O2technologiesAutomation/ExtendReports/screenshots/" + screenshotName + "_" + timestamp + ".png";
